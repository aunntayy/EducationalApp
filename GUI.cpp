...
void MainWindow::createControlPanel(){
    ...
    // QDial* heightDial = new QDial(this); // could make vertical slider
    // heightDial->setRange(1,30);
    // heightDial->setWrapping(false);
    // heightDial->setNotchesVisible(true);
    // connect(heightDial, &QDial::valueChanged, this, [=](int selectedAntennaHeight)
    // {
    //     emit antennaHeightAdjusted(selectedAntennaHeight);
    // });
    // heightLayout->addWidget(heightLabel);
    // heightLayout->addWidget(heightDial);
    ...
    //instructionBtn->setFixedSize(120, 35);
    ...
    //gameMenuButton->setFixedSize(120, 35);
    ...
    //connect(gameMenuButton, &QPushButton::clicked, this, &MainWindow::displayGameMenu);
...
void MainWindow::updateGameWorld() // should this just be displayLevel again?
{
