...
GameMenuPage::GameMenuPage(QWidget* parent) : QWidget(parent)
{
    ...
    // QLabel* titleLabel = new QLabel("Welcome to Radio Application", this);
    ...
    //aboutBtnLayout->addWidget(aboutButton);

    //layout->addWidget(titleLabel);

    layout->addLayout(menuLayout);
    //layout->addLayout(aboutBtnLayout);
...
// int GameMenuPage::getSelectedLevel() const
// {
//     return level;
// }
