...
//method that b2vec2 and then emit it to main
// main call the displayLevel
// in displayLevel we have a environment obj -> drawParticle tada
...
// Factory methods for creating levels

// level zero for testing and debugging
